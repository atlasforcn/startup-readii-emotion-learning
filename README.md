...
- 使用者與痛點：服務對象是閱讀學習者、教師與家長；核心需求是看見閱讀卡點與情緒回饋，而不是替學生貼標籤。
- 市場與差異：替代方案包含紙本閱讀單、測驗與一般學習平台；差異在學習紀錄、情境回饋與教師複核。早期客群以班級試辦切入，採購與導入需處理教師工時及家長信任。
- 驗證：以場域試辦紀錄完成率、教師修改率、學習回饋、持續使用與閱讀成效指標，不以單次情緒結果判定能力。
- 商業模式：學校或補教單位依班級付費訂閱，收入來自授權與導入；成本包括內容、教師支援與個資維運，報價與毛利需實測。
- 專業邊界：情緒訊號不可取代教師、輔導老師、心理師或醫療專業人員，也不構成心理診斷；高風險狀況必須人工複核與升級。
